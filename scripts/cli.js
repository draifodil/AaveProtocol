...
const contractABI = require("../artifacts/contracts/Aaveprotocol.sol/Aaveprotocol.json").abi;

program
    .name("aaveprotocol-cli")
    .description("CLI tool for Aaveprotocol smart contract")
    .version("1.0.0");
